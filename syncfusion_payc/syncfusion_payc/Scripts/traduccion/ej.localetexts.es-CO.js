(function ($, ej, undefined) {
    var name, widgets;
    if (ej.locales.indexOf("esCO") < 0)
        ej.locales.push("esCO");
    $.fn.Locale_esCO = function (pluginName) {
        switch (pluginName) {
            case "ejAutocomplete":
                ej.Autocomplete.Locale = ej.Autocomplete.Locale || {};
                ej.Autocomplete.Locale["es-CO"] = {
            ...
            case "ejCurrencyTextbox":
                ...
                ej.CurrencyTextbox.Locale["es-CO"] = {
            ...
            case "ejDateRangePicker":
                ...
                ej.DateRangePicker.Locale["es-CO"] = {
                    ButtonText: {
                        apply: "aplicar",
                        cancel: "cancelar",
                        reset: "Reiniciar"
            ...
            case "ejDropDownList":
                ...
                ej.DropDownList.Locale["es-CO"] = {
                    emptyResultText: "No hay sugerencias,",
                    watermarkText: " ",
                };
                break;
            case "ejComboBox":
                ej.ComboBox.Locale["es-CO"] = {
                    noRecordsTemplate: "No se encontrarón archivos",
                    actionFailureTemplate: "La solicitud falló"
                };
                break;
            case "ejMenu":
                ej.Menu.Locale["es-CO"] = {
                    titleText: "menú"
                };
                break;
            case "ejCaptcha":
                ej.Captcha.Locale["es-CO"] = {
            ...
            case "ejmobile":
                ...
                if (ej.mobile.DatePicker) {
                    ...
                    ej.mobile.DatePicker.Locale["es-CO"] = {
                        confirmText: "Hecho",
                        Windows: {
                            cancelText: "Cancelar",
                ...
                if (ej.mobile.TimePicker) {
                    ...
                    ej.mobile.TimePicker.Locale["es-CO"] = {
                        confirmText: "Hecho",
                        AM: "A.M",
                        PM: "P.M",
                        Android: {
            ...
            case "ejPercentageTextbox":
                ...
                ej.PercentageTextbox.Locale["es-CO"] = {
                    watermarkText: "introducir el valor",
                };
                break;
            case "ejPivotGrid":
                ej.PivotGrid.Locale = ej.PivotGrid.Locale || {};
                ej.PivotGrid.Locale["es-CO"] = {
                    Total: "Total",
            ...
            case "ejDiagram":
                ...
                ej.datavisualization.Diagram.Locale["es-CO"] = {
                    cut: "Cortar",
                    copy: "Copia",
                    paste: "Pegar",
                    undo: "Deshacer",
            ...
            case "ejChart":
                ...
                ej.datavisualization.Chart.Locale["es-CO"] = {
                    zoomIn: "Acercarse",
                    zoomOut: "Disminuir el zoom",
                    zoom: "Enfocar",
                    pan: "Pan",
            ...
            case "ejRangeNavigator":
                ...
                ej.datavisualization.RangeNavigator.Locale["es-CO"] = {
                    intervals: {
                        quarter: {
            ...
            case "ejMap":
                ...
                ej.datavisualization.Map.Locale["es-CO"] = {
                    zoomIn: "Acercarse",
                    zoomOut: "Disminuir el zoom",
                    panTop: "Pan Top",
                    panBottom: "pan fondo",
            ...
            case "ejReportDesigner":
                ...
                ej.ReportDesigner.Locale['es-CO'] = {
                    itemPanel: {
                    ...
                    expression: {
                        ...
                        description: {
                            ...
                            interestPayment: 'Devuelve el valor doble que especifica el pago de interesCO para un período determinado de una anualidad basado en pagos fijos periódicos y una tasa de interés fija.',
            ...
            case "ejRecurrenceEditor":
                ...
                ej.RecurrenceEditor.Locale["es-CO"] = {
                    Repeat: "Repetir",
                    Never: "Nunca",
                    Daily: "Diariamente",
                    Weekly: "Semanal",
            ...
            case "ejSchedule":
                ...
                ej.Schedule.Locale["es-CO"] = {
                    ...
                    RecurrenceDateValidation: "Algunos mesCO tienen menos fechas seleccionadas. Durante estos mesCO, la ocurrencia caerá en la última fecha del mes",
            ...
            case "ejSpreadsheet":
                ...
                ej.Spreadsheet.Locale["es-CO"] = {
                    ...
                    LineChartContent: "Utilizar este tipo de gráfico para mostrar tendencias en el tiempo (años, mesCO y días) o categorías.",
                    AreaChart: "Area",
                    AreaChartTitle: "Insertar gráfico Área",
                    AreaChartContent: "Utilizar este tipo de gráfico para mostrar tendencias en el tiempo (años, mesCO y días) o categorías. Lo utilizan para destacar la magnitud del cambio en el tiempo.",
                    ComboChart: "Combo",
                    PieChart: "Tarta",
            ...
            case "ejTile":
                ...
                ej.Tile.Locale["es-CO"] = {
                    captionText: "Texto"
                };
                break;
            case "ejListView":
                ej.ListView.Locale = ej.ListView.Locale || {};
                ej.ListView.Locale["es-CO"] = {
                    headerTitle: "Título",
