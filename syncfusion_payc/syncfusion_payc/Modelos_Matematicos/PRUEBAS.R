factura <- function(cod_factura) {
    ...
    #FUNCION QUE CALCULA EL NUMERO DE HORAS DE ADICION O DESCUENTO, DE ACUERDO CON EL REGISTRO DE NOVEDADES -----
    ...
    #CONEXION Y EXTRACCION DE LA INFORMACION DE LA BASE DE DATOS---------------
    #CONEXION A LA BASE DE DATOS
    ...
    #CALCULO E INSERCION DE LA INFORMACION EN LAS TABLAS
